...
@interface KKCardBalanceResponse : AWSModel
...
@property (nonatomic, strong, nullable) NSNumber *balanceSpecified;


@property (nonatomic, strong, nullable) NSString *expirationDate;


@property (nonatomic, strong, nullable) NSNumber *expirationDateSpecified;
